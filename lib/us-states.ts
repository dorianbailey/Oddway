/**
 * US state and territory names, keyed by the two-letter code the schema
 * stores. Used for page titles and the filter, so "WV" reads as
 * "West Virginia" rather than making people decode abbreviations.
 */
